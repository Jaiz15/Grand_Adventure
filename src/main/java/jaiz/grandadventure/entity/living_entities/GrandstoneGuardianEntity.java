...
public class GrandstoneGuardianEntity extends PathAwareEntity {

    public GrandstoneGuardianEntity(EntityType<? extends PathAwareEntity> entityType, World world) {
